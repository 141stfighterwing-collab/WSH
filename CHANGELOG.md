...
- Fixed excessive wasted space between note editor and sidebars by using `max-w-4xl mx-auto` on main content area
...
- Main content area centers with `max-w-4xl mx-auto` for comfortable reading width
