...
> WeaveNote Self-Hosted v4.1.2 — Complete reference documentation
...
| **Images** | `weavenote:4.1.2`, `weavenote:latest`, `weavenote-app` | Exact tag match |
...
# Remove WSH image
docker rmi -f weavenote:4.1.2 2>/dev/null
...
|-----------|-------|---------|-------|
| `weavenote-app` | `weavenote:4.1.2` (built locally) | Main Next.js application | 8883 |
