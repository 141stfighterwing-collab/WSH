...
> WeaveNote Self-Hosted v4.3.4 — Complete reference documentation
...
| **Images** | `weavenote:4.3.4`, `weavenote:latest`, `weavenote-app` | Exact tag match |
...
# Remove WSH image
docker rmi -f weavenote:4.3.4 2>/dev/null
...
|-----------|-------|---------|-------|
| `weavenote-app` | `weavenote:4.3.4` (built locally) | Main Next.js application | 8883 |
