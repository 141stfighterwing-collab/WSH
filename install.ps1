...
# v3.9.3: Multi-stage Docker build. Installs a pre-built image.
...
Write-Host "  WSH - Auto Nuke & Reinstall v3.9.3" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
    ...
    $manifestContent = @"
{
  ...
  "resources": {
    ...
    "images": ["weavenote:3.9.3", "weavenote:latest"],
...
$wshImages = @("weavenote:3.9.3", "weavenote:latest", "weavenote-app")
$foundImages = 0
