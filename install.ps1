...
# v4.1.1: Multi-stage Docker build. Installs a pre-built image.
...
Write-Host "  WSH - Auto Nuke & Reinstall v4.1.1" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
    ...
    $manifestContent = @"
{
  ...
  "resources": {
    ...
    "images": ["weavenote:4.1.1", "weavenote:latest"],
...
$wshImages = @("weavenote:4.1.1", "weavenote:latest", "weavenote-app")
$foundImages = 0
